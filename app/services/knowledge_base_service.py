...
class KnowledgeBaseMetadataService:
    ...
    async def list_metadata(self, include_deleted: bool = False) -> List[KnowledgeBaseMetadata]:
        """
        列出所有知识库元数据
        :param include_deleted: 是否包含已删除的知识库
        :return: 知识库元数据列表
        """
    ...
    async def upsert_metadata(
        ...
        *,
        ...
        """
        更新或插入知识库元数据
        :param ragflow_dataset_id: RAGFlow 数据集 ID
        :param name: 知识库名称
        :param description: 知识库描述
        :param owner: 知识库所有者
        :param visibility: 知识库可见性
        :param tags: 知识库标签
        :param notes: 知识库备注
        :param extra_config: 知识库额外配置
        :param status: 知识库状态
    ...
    async def update_metadata(
        ...
        *,
        ...
        """
        更新知识库元数据
        :param dataset_id: RAGFlow 数据集 ID
        :param name: 知识库名称
        :param description: 知识库描述
        :param owner: 知识库所有者
        :param visibility: 知识库可见性
    ...
    async def mark_deleted(self, dataset_ids: Iterable[str], user_name: Optional[str] = None) -> None:
        """
        标记知识库为已删除
        :param dataset_ids: RAGFlow 数据集 ID 列表
        :param user_name: 操作用户名称
        :return: None
        """
    ...
    async def sync_from_ragflow_datasets(
        ...
        """
        从 RAGFlow 数据集同步知识库元数据
        :param ragflow_datasets: RAGFlow 数据集列表
        :param user_name: 操作用户名称
        :return: None
        """
    ...
    async def merge_with_ragflow(self, ragflow_datasets: List[Dict[str, Any]], include_missing: bool = True) -> List[Dict[str, Any]]:
        """
        合并 RAGFlow 数据集与知识库元数据
        :param ragflow_datasets: RAGFlow 数据集列表
        :param include_missing: 是否包含缺失的 RAGFlow 数据集
        :return: 合并后的知识库元数据列表
        """
